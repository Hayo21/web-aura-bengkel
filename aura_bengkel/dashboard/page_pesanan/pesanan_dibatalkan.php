...
$sql = "SELECT * FROM pemesanan_layanan WHERE status='dibatalkan' AND (nama_lengkap LIKE '%$search%' OR email LIKE '%$search%' OR nomor_telepon LIKE '%$search%')";

// Filter berdasarkan bulan jika ada filter bulan yang dipilih
if (!empty($bulan)) {
...
<body style="background-color: #2d3250;">
    ...
    <div class="container mt-5">
        <h2 class="text-center mb-4">Pesanan Dibatalkan</h2>
        <a href="../admin_page.php" class="btn btn-primary mb-3">Kembali ke Halaman Admin</a>

        

        <!-- Form Pencarian -->
        <form method="GET" action="pesanan_dibatalkan.php" class="mb-3">
        ...
        <form method="GET" action="pesanan_dibatalkan.php" class="mb-3">
            <div class="input-group">
                ...
                <a href="pesanan_dibatalkan.php" class="btn btn-danger">Clear Filter</a>
            </div>
        </form>
        ...
        <div class="card shadow">
            <div class="card-body">
                <h3 class="card-title">Daftar Pesanan Dibatalkan</h3>
                    ...
                    <table class="table table-dark table-striped">
                        ...
                        <tbody>
                            ...
                            if ($result->num_rows > 0) {
                                ...
                                echo "<tr><td colspan='13' class='text-center'>Tidak ada pesanan dibatalkan</td></tr>";
                            }
                            ?>
                        </tbody>
                    </table>
